...
class TorchLossComputer(object):
    @staticmethod
    def compute_complex_absolute_given_k(output, k, N, device="cuda:0"):
    ...
    @staticmethod
    def complex_absolute(output, Fs, bpm_range=None, device="cuda:0"):
    ...
    @staticmethod
    def cross_entropy_power_spectrum_loss(inputs, target, Fs, device="cuda:0"):
    ...
    @staticmethod
    def cross_entropy_power_spectrum_focal_loss(inputs, target, Fs, gamma, device="cuda:0"):
        inputs = inputs.view(1, -1)
        target = target.view(1, -1)
        bpm_range = torch.arange(40, 180, dtype=torch.float).cuda()
    ...
    @staticmethod
    def cross_entropy_power_spectrum_forward_pred(inputs, Fs, device="cuda:0"):
        inputs = inputs.view(1, -1)
    ...
    @staticmethod
    def cross_entropy_power_spectrum_DLDL_softmax2(inputs, target, Fs, std, device="cuda:0"):
