...
class BaseTrainer:
    ...
    def save_test_outputs(self, predictions, labels, config, lifenesses=None, labels_shuffled=None, uncertainties=None, heart_rates=None, heart_rates_uncertainty=None, heart_rates_labels=None):
        ...
        data['lifenesses'] = lifenesses
        data['labels_shuffled'] = labels_shuffled
        data['uncertainties'] = uncertainties
        data['heart_rates'] = heart_rates
        data['heart_rates_uncertainty'] = heart_rates_uncertainty
        data['heart_rates_labels'] = heart_rates_labels
