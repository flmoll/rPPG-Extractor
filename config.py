...
_C.TRAIN.LR = 1e-4
_C.TRAIN.WD = 1e-4
_C.TRAIN.EARLY_STOPPING_EPOCHS = -1
# Optimizer
...
_C.TRAIN.PERSISTENT_WORKERS = True

# Train.Data settings
_C.TRAIN.DATA = CN()

### -----------------------------------------------------------------------------
# inference Model settings. This is only for the Heart rate classifier model
# -----------------------------------------------------------------------------
_C.TRAIN.DATA.PPG_INFERENCE_MODEL = CN()
# Model name
_C.TRAIN.DATA.PPG_INFERENCE_MODEL.NAME = ''
# Checkpoint to resume, could be overwritten by command line argument
_C.TRAIN.DATA.PPG_INFERENCE_MODEL.RESUME = ''
# Dropout rate
_C.TRAIN.DATA.PPG_INFERENCE_MODEL.DROP_RATE = 0.0
_C.TRAIN.DATA.PPG_INFERENCE_MODEL.MODEL_DIR = 'PreTrainedModels'

# Specific parameters for physnet parameters
_C.TRAIN.DATA.PPG_INFERENCE_MODEL.PHYSNET = CN()
_C.TRAIN.DATA.PPG_INFERENCE_MODEL.PHYSNET.FRAME_NUM = 64

_C.TRAIN.DATA.PPG_INFERENCE_MODEL.FLAVOUR = "None"
_C.TRAIN.DATA.PPG_INFERENCE_MODEL.MODEL_PATH = "None"
_C.TRAIN.DATA.PPG_INFERENCE_MODEL.POSTPROCESS = "None"

# -----------------------------------------------------------------------------
# Specific parameters for iBVPNet parameters
# -----------------------------------------------------------------------------
_C.TRAIN.DATA.PPG_INFERENCE_MODEL.iBVPNet = CN()
_C.TRAIN.DATA.PPG_INFERENCE_MODEL.iBVPNet.FRAME_NUM = 160
_C.TRAIN.DATA.PPG_INFERENCE_MODEL.iBVPNet.CHANNELS = 3
# -----------------------------------------------------------------------------
# Specific parameters for FactorizePhys parameters
# -----------------------------------------------------------------------------
_C.TRAIN.DATA.PPG_INFERENCE_MODEL.FactorizePhys = CN()
_C.TRAIN.DATA.PPG_INFERENCE_MODEL.FactorizePhys.FRAME_NUM = 160
_C.TRAIN.DATA.PPG_INFERENCE_MODEL.FactorizePhys.CHANNELS = 3
_C.TRAIN.DATA.PPG_INFERENCE_MODEL.FactorizePhys.TYPE = "Standard"
_C.TRAIN.DATA.PPG_INFERENCE_MODEL.FactorizePhys.MD_FSAM = False
_C.TRAIN.DATA.PPG_INFERENCE_MODEL.FactorizePhys.MD_TYPE = 'NMF'
_C.TRAIN.DATA.PPG_INFERENCE_MODEL.FactorizePhys.MD_TRANSFORM = 'T_KAB'
_C.TRAIN.DATA.PPG_INFERENCE_MODEL.FactorizePhys.MD_R = 1
_C.TRAIN.DATA.PPG_INFERENCE_MODEL.FactorizePhys.MD_S = 1
_C.TRAIN.DATA.PPG_INFERENCE_MODEL.FactorizePhys.MD_STEPS = 4
_C.TRAIN.DATA.PPG_INFERENCE_MODEL.FactorizePhys.MD_INFERENCE = True
_C.TRAIN.DATA.PPG_INFERENCE_MODEL.FactorizePhys.MD_RESIDUAL = True

# -----------------------------------------------------------------------------
# Model Settings for TS-CAN
# -----------------------------------------------------------------------------
_C.TRAIN.DATA.PPG_INFERENCE_MODEL.TSCAN = CN()
_C.TRAIN.DATA.PPG_INFERENCE_MODEL.TSCAN.FRAME_DEPTH = 10

# -----------------------------------------------------------------------------
# Model Settings for EfficientPhys
# -----------------------------------------------------------------------------
_C.TRAIN.DATA.PPG_INFERENCE_MODEL.EFFICIENTPHYS = CN()
_C.TRAIN.DATA.PPG_INFERENCE_MODEL.EFFICIENTPHYS.FRAME_DEPTH = 10

# -----------------------------------------------------------------------------
# Model Settings for BigSmall
# -----------------------------------------------------------------------------
_C.TRAIN.DATA.PPG_INFERENCE_MODEL.BIGSMALL = CN()
_C.TRAIN.DATA.PPG_INFERENCE_MODEL.BIGSMALL.FRAME_DEPTH = 3

# -----------------------------------------------------------------------------
# Model Settings for PhysFormer
# -----------------------------------------------------------------------------
_C.TRAIN.DATA.PPG_INFERENCE_MODEL.PHYSFORMER = CN()
_C.TRAIN.DATA.PPG_INFERENCE_MODEL.PHYSFORMER.PATCH_SIZE = 4
_C.TRAIN.DATA.PPG_INFERENCE_MODEL.PHYSFORMER.DIM = 96
_C.TRAIN.DATA.PPG_INFERENCE_MODEL.PHYSFORMER.FF_DIM = 144
_C.TRAIN.DATA.PPG_INFERENCE_MODEL.PHYSFORMER.NUM_HEADS = 4
_C.TRAIN.DATA.PPG_INFERENCE_MODEL.PHYSFORMER.NUM_LAYERS = 12
_C.TRAIN.DATA.PPG_INFERENCE_MODEL.PHYSFORMER.THETA = 0.7
...
_C.TRAIN.DATA.COMPRESSION_FORMAT = 'None'
_C.TRAIN.DATA.CACHE_UNCOMPRESSED = None
...
_C.TRAIN.DATA.BEGINS = [0.0]
_C.TRAIN.DATA.ENDS = [1.0]
_C.TRAIN.DATA.DATA_AUG = []
_C.TRAIN.DATA.FOLD = CN()
_C.TRAIN.DATA.FOLD.FOLD_NAME = ''
_C.TRAIN.DATA.FOLD.FOLD_PATH = ''
# Train Data preprocessing
_C.TRAIN.DATA.PREPROCESS = CN()
_C.TRAIN.DATA.PREPROCESS.VIDEO_SUBSET_TO_USE = []
_C.TRAIN.DATA.PREPROCESS.USE_PSUEDO_PPG_LABEL = False
_C.TRAIN.DATA.PREPROCESS.DATA_TYPE = ['']
_C.TRAIN.DATA.PREPROCESS.CONVERT_TO_TYPE = 'None'
_C.TRAIN.DATA.PREPROCESS.DATA_AUG = ['None']
_C.TRAIN.DATA.PREPROCESS.LABEL_TYPE = ''
_C.TRAIN.DATA.PREPROCESS.CONVERT_LABEL_TO_TYPE = 'None'
_C.TRAIN.DATA.PREPROCESS.ARTIFICIAL_DESTABILISATION_BACKEND = 'None'
_C.TRAIN.DATA.PREPROCESS.ARTIFICIAL_DESTABILISATION_AMPLITUDE = 10.0
_C.TRAIN.DATA.PREPROCESS.DEEPSTAB_PREPROCESSED_PATH = ""
...
_C.TRAIN.DATA.PREPROCESS.RESIZE.ADDITIONAL_SIZES = None
_C.TRAIN.DATA.PREPROCESS.RESIZE.RESIZE_IMAGE_AFTER_PREPROCESS_RESOLUTION = None
...
_C.VALID.NUM_WORKERS = 4
_C.VALID.PIN_MEMORY = True
_C.VALID.PERSISTENT_WORKERS = True
...
# inference Model settings. This is only for the Heart rate classifier model
# -----------------------------------------------------------------------------
_C.VALID.DATA.PPG_INFERENCE_MODEL = CN()
# Model name
_C.VALID.DATA.PPG_INFERENCE_MODEL.NAME = ''
# Checkpoint to resume, could be overwritten by command line argument
_C.VALID.DATA.PPG_INFERENCE_MODEL.RESUME = ''
# Dropout rate
_C.VALID.DATA.PPG_INFERENCE_MODEL.DROP_RATE = 0.0
_C.VALID.DATA.PPG_INFERENCE_MODEL.MODEL_DIR = 'PreTrainedModels'

# Specific parameters for physnet parameters
_C.VALID.DATA.PPG_INFERENCE_MODEL.PHYSNET = CN()
_C.VALID.DATA.PPG_INFERENCE_MODEL.PHYSNET.FRAME_NUM = 64

_C.VALID.DATA.PPG_INFERENCE_MODEL.FLAVOUR = "None"
_C.VALID.DATA.PPG_INFERENCE_MODEL.MODEL_PATH = "None"
_C.VALID.DATA.PPG_INFERENCE_MODEL.POSTPROCESS = "None"

# -----------------------------------------------------------------------------
# Specific parameters for iBVPNet parameters
# -----------------------------------------------------------------------------
_C.VALID.DATA.PPG_INFERENCE_MODEL.iBVPNet = CN()
_C.VALID.DATA.PPG_INFERENCE_MODEL.iBVPNet.FRAME_NUM = 160
_C.VALID.DATA.PPG_INFERENCE_MODEL.iBVPNet.CHANNELS = 3
# -----------------------------------------------------------------------------
# Specific parameters for FactorizePhys parameters
# -----------------------------------------------------------------------------
_C.VALID.DATA.PPG_INFERENCE_MODEL.FactorizePhys = CN()
_C.VALID.DATA.PPG_INFERENCE_MODEL.FactorizePhys.FRAME_NUM = 160
_C.VALID.DATA.PPG_INFERENCE_MODEL.FactorizePhys.CHANNELS = 3
_C.VALID.DATA.PPG_INFERENCE_MODEL.FactorizePhys.TYPE = "Standard"
_C.VALID.DATA.PPG_INFERENCE_MODEL.FactorizePhys.MD_FSAM = False
_C.VALID.DATA.PPG_INFERENCE_MODEL.FactorizePhys.MD_TYPE = 'NMF'
_C.VALID.DATA.PPG_INFERENCE_MODEL.FactorizePhys.MD_TRANSFORM = 'T_KAB'
_C.VALID.DATA.PPG_INFERENCE_MODEL.FactorizePhys.MD_R = 1
_C.VALID.DATA.PPG_INFERENCE_MODEL.FactorizePhys.MD_S = 1
_C.VALID.DATA.PPG_INFERENCE_MODEL.FactorizePhys.MD_STEPS = 4
_C.VALID.DATA.PPG_INFERENCE_MODEL.FactorizePhys.MD_INFERENCE = True
_C.VALID.DATA.PPG_INFERENCE_MODEL.FactorizePhys.MD_RESIDUAL = True

# -----------------------------------------------------------------------------
# Model Settings for TS-CAN
# -----------------------------------------------------------------------------
_C.VALID.DATA.PPG_INFERENCE_MODEL.TSCAN = CN()
_C.VALID.DATA.PPG_INFERENCE_MODEL.TSCAN.FRAME_DEPTH = 10

# -----------------------------------------------------------------------------
# Model Settings for EfficientPhys
# -----------------------------------------------------------------------------
_C.VALID.DATA.PPG_INFERENCE_MODEL.EFFICIENTPHYS = CN()
_C.VALID.DATA.PPG_INFERENCE_MODEL.EFFICIENTPHYS.FRAME_DEPTH = 10

# -----------------------------------------------------------------------------
# Model Settings for BigSmall
# -----------------------------------------------------------------------------
_C.VALID.DATA.PPG_INFERENCE_MODEL.BIGSMALL = CN()
_C.VALID.DATA.PPG_INFERENCE_MODEL.BIGSMALL.FRAME_DEPTH = 3

# -----------------------------------------------------------------------------
# Model Settings for PhysFormer
# -----------------------------------------------------------------------------
_C.VALID.DATA.PPG_INFERENCE_MODEL.PHYSFORMER = CN()
_C.VALID.DATA.PPG_INFERENCE_MODEL.PHYSFORMER.PATCH_SIZE = 4
_C.VALID.DATA.PPG_INFERENCE_MODEL.PHYSFORMER.DIM = 96
_C.VALID.DATA.PPG_INFERENCE_MODEL.PHYSFORMER.FF_DIM = 144
_C.VALID.DATA.PPG_INFERENCE_MODEL.PHYSFORMER.NUM_HEADS = 4
_C.VALID.DATA.PPG_INFERENCE_MODEL.PHYSFORMER.NUM_LAYERS = 12
_C.VALID.DATA.PPG_INFERENCE_MODEL.PHYSFORMER.THETA = 0.7
...
_C.VALID.DATA.COMPRESSION_FORMAT = 'None'
_C.VALID.DATA.CACHE_UNCOMPRESSED = None
...
_C.VALID.DATA.BEGINS = [0.0]
_C.VALID.DATA.ENDS = [1.0]
_C.VALID.DATA.DATA_AUG = []
...
_C.VALID.DATA.PREPROCESS.VIDEO_SUBSET_TO_USE = []
_C.VALID.DATA.PREPROCESS.USE_PSUEDO_PPG_LABEL = False
_C.VALID.DATA.PREPROCESS.DATA_TYPE = ['']
_C.VALID.DATA.PREPROCESS.CONVERT_TO_TYPE = 'None'
_C.VALID.DATA.PREPROCESS.DATA_AUG = ['None']
_C.VALID.DATA.PREPROCESS.LABEL_TYPE = ''
_C.VALID.DATA.PREPROCESS.CONVERT_LABEL_TO_TYPE = 'None'
_C.VALID.DATA.PREPROCESS.ARTIFICIAL_DESTABILISATION_BACKEND = 'None'
_C.VALID.DATA.PREPROCESS.ARTIFICIAL_DESTABILISATION_AMPLITUDE = 10.0
_C.VALID.DATA.PREPROCESS.DEEPSTAB_PREPROCESSED_PATH = ""
...
_C.VALID.DATA.PREPROCESS.RESIZE.ADDITIONAL_SIZES = None
_C.VALID.DATA.PREPROCESS.RESIZE.RESIZE_IMAGE_AFTER_PREPROCESS_RESOLUTION = None
...
_C.TEST.PERSISTENT_WORKERS = True
...
# inference Model settings. This is only for the Heart rate classifier model
# -----------------------------------------------------------------------------
_C.TEST.DATA.PPG_INFERENCE_MODEL = CN()
# Model name
_C.TEST.DATA.PPG_INFERENCE_MODEL.NAME = ''
# Checkpoint to resume, could be overwritten by command line argument
_C.TEST.DATA.PPG_INFERENCE_MODEL.RESUME = ''
# Dropout rate
_C.TEST.DATA.PPG_INFERENCE_MODEL.DROP_RATE = 0.0
_C.TEST.DATA.PPG_INFERENCE_MODEL.MODEL_DIR = 'PreTrainedModels'

# Specific parameters for physnet parameters
_C.TEST.DATA.PPG_INFERENCE_MODEL.PHYSNET = CN()
_C.TEST.DATA.PPG_INFERENCE_MODEL.PHYSNET.FRAME_NUM = 64

_C.TEST.DATA.PPG_INFERENCE_MODEL.FLAVOUR = "None"
_C.TEST.DATA.PPG_INFERENCE_MODEL.MODEL_PATH = "None"
_C.TEST.DATA.PPG_INFERENCE_MODEL.POSTPROCESS = "None"

# -----------------------------------------------------------------------------
# Specific parameters for iBVPNet parameters
# -----------------------------------------------------------------------------
_C.TEST.DATA.PPG_INFERENCE_MODEL.iBVPNet = CN()
_C.TEST.DATA.PPG_INFERENCE_MODEL.iBVPNet.FRAME_NUM = 160
_C.TEST.DATA.PPG_INFERENCE_MODEL.iBVPNet.CHANNELS = 3
# -----------------------------------------------------------------------------
# Specific parameters for FactorizePhys parameters
# -----------------------------------------------------------------------------
_C.TEST.DATA.PPG_INFERENCE_MODEL.FactorizePhys = CN()
_C.TEST.DATA.PPG_INFERENCE_MODEL.FactorizePhys.FRAME_NUM = 160
_C.TEST.DATA.PPG_INFERENCE_MODEL.FactorizePhys.CHANNELS = 3
_C.TEST.DATA.PPG_INFERENCE_MODEL.FactorizePhys.TYPE = "Standard"
_C.TEST.DATA.PPG_INFERENCE_MODEL.FactorizePhys.MD_FSAM = False
_C.TEST.DATA.PPG_INFERENCE_MODEL.FactorizePhys.MD_TYPE = 'NMF'
_C.TEST.DATA.PPG_INFERENCE_MODEL.FactorizePhys.MD_TRANSFORM = 'T_KAB'
_C.TEST.DATA.PPG_INFERENCE_MODEL.FactorizePhys.MD_R = 1
_C.TEST.DATA.PPG_INFERENCE_MODEL.FactorizePhys.MD_S = 1
_C.TEST.DATA.PPG_INFERENCE_MODEL.FactorizePhys.MD_STEPS = 4
_C.TEST.DATA.PPG_INFERENCE_MODEL.FactorizePhys.MD_INFERENCE = True
_C.TEST.DATA.PPG_INFERENCE_MODEL.FactorizePhys.MD_RESIDUAL = True

# -----------------------------------------------------------------------------
# Model Settings for TS-CAN
# -----------------------------------------------------------------------------
_C.TEST.DATA.PPG_INFERENCE_MODEL.TSCAN = CN()
_C.TEST.DATA.PPG_INFERENCE_MODEL.TSCAN.FRAME_DEPTH = 10

# -----------------------------------------------------------------------------
# Model Settings for EfficientPhys
# -----------------------------------------------------------------------------
_C.TEST.DATA.PPG_INFERENCE_MODEL.EFFICIENTPHYS = CN()
_C.TEST.DATA.PPG_INFERENCE_MODEL.EFFICIENTPHYS.FRAME_DEPTH = 10

# -----------------------------------------------------------------------------
# Model Settings for BigSmall
# -----------------------------------------------------------------------------
_C.TEST.DATA.PPG_INFERENCE_MODEL.BIGSMALL = CN()
_C.TEST.DATA.PPG_INFERENCE_MODEL.BIGSMALL.FRAME_DEPTH = 3

# -----------------------------------------------------------------------------
# Model Settings for PhysFormer
# -----------------------------------------------------------------------------
_C.TEST.DATA.PPG_INFERENCE_MODEL.PHYSFORMER = CN()
_C.TEST.DATA.PPG_INFERENCE_MODEL.PHYSFORMER.PATCH_SIZE = 4
_C.TEST.DATA.PPG_INFERENCE_MODEL.PHYSFORMER.DIM = 96
_C.TEST.DATA.PPG_INFERENCE_MODEL.PHYSFORMER.FF_DIM = 144
_C.TEST.DATA.PPG_INFERENCE_MODEL.PHYSFORMER.NUM_HEADS = 4
_C.TEST.DATA.PPG_INFERENCE_MODEL.PHYSFORMER.NUM_LAYERS = 12
_C.TEST.DATA.PPG_INFERENCE_MODEL.PHYSFORMER.THETA = 0.7
...
_C.TEST.DATA.COMPRESSION_FORMAT = 'None'
_C.TEST.DATA.CACHE_UNCOMPRESSED = None
...
_C.TEST.DATA.BEGINS = [0.0]
_C.TEST.DATA.ENDS = [1.0]
_C.TEST.DATA.DATA_AUG = []
_C.TEST.DATA.FOLD = CN()
_C.TEST.DATA.FOLD.FOLD_NAME = ''
_C.TEST.DATA.FOLD.FOLD_PATH = ''
# Test Data preprocessing
_C.TEST.DATA.PREPROCESS = CN()
_C.TEST.DATA.PREPROCESS.VIDEO_SUBSET_TO_USE = []
_C.TEST.DATA.PREPROCESS.USE_PSUEDO_PPG_LABEL = False
_C.TEST.DATA.PREPROCESS.DATA_TYPE = ['']
_C.TEST.DATA.PREPROCESS.CONVERT_TO_TYPE = 'None'
_C.TEST.DATA.PREPROCESS.DATA_AUG = ['None']
_C.TEST.DATA.PREPROCESS.LABEL_TYPE = ''
_C.TEST.DATA.PREPROCESS.CONVERT_LABEL_TO_TYPE = 'None'
_C.TEST.DATA.PREPROCESS.ARTIFICIAL_DESTABILISATION_BACKEND = 'None'
_C.TEST.DATA.PREPROCESS.ARTIFICIAL_DESTABILISATION_AMPLITUDE = 10.0
_C.TEST.DATA.PREPROCESS.DEEPSTAB_PREPROCESSED_PATH = ""
...
_C.TEST.DATA.PREPROCESS.RESIZE.ADDITIONAL_SIZES = None
_C.TEST.DATA.PREPROCESS.RESIZE.RESIZE_IMAGE_AFTER_PREPROCESS_RESOLUTION = None
...
_C.UNSUPERVISED.DATA.COMPRESSION_FORMAT = 'None'
_C.UNSUPERVISED.DATA.CACHE_UNCOMPRESSED = None
...
_C.UNSUPERVISED.DATA.BEGINS = [0.0]
_C.UNSUPERVISED.DATA.ENDS = [1.0]
_C.UNSUPERVISED.DATA.DATA_AUG = []
...
_C.UNSUPERVISED.DATA.PREPROCESS.VIDEO_SUBSET_TO_USE = []
_C.UNSUPERVISED.DATA.PREPROCESS.USE_PSUEDO_PPG_LABEL = False
_C.UNSUPERVISED.DATA.PREPROCESS.DATA_TYPE = ['']
_C.UNSUPERVISED.DATA.PREPROCESS.CONVERT_TO_TYPE = 'None'
_C.UNSUPERVISED.DATA.PREPROCESS.ARTIFICIAL_DESTABILISATION_BACKEND = 'None'
_C.UNSUPERVISED.DATA.PREPROCESS.ARTIFICIAL_DESTABILISATION_AMPLITUDE = 10.0
_C.UNSUPERVISED.DATA.PREPROCESS.DEEPSTAB_PREPROCESSED_PATH = ""
...
_C.UNSUPERVISED.DATA.PREPROCESS.RESIZE.RESIZE_IMAGE_AFTER_PREPROCESS_RESOLUTION = None
        ...
        config.TRAIN.DATA.EXP_DATA_NAME = "_".join([config.TRAIN.DATA.DATASET, "SizeW{0}".format(
            ...
            str(config.TRAIN.DATA.PREPROCESS.CHUNK_LENGTH)), "DataType{0}".format("_".join(config.TRAIN.DATA.PREPROCESS.DATA_TYPE)),
                                      ...
                                      "Dyamic_Det{0}".format(config.TRAIN.DATA.PREPROCESS.CROP_FACE.DETECTION.DO_DYNAMIC_DETECTION),
                                        ...
                                        "D{0}".format(config.TRAIN.DATA.PREPROCESS.ARTIFICIAL_DESTABILISATION_BACKEND),
                                        "amp{0}".format(config.TRAIN.DATA.PREPROCESS.ARTIFICIAL_DESTABILISATION_AMPLITUDE)
                                              ])
            ...
            config.VALID.DATA.EXP_DATA_NAME = "_".join([config.VALID.DATA.DATASET, "SizeW{0}".format(
                ...
                str(config.VALID.DATA.PREPROCESS.CHUNK_LENGTH)), "DataType{0}".format("_".join(config.VALID.DATA.PREPROCESS.DATA_TYPE)),
                                        ...
                                        "Dyamic_Det{0}".format(config.VALID.DATA.PREPROCESS.CROP_FACE.DETECTION.DO_DYNAMIC_DETECTION),
                                          ...
                                          "D{0}".format(config.VALID.DATA.PREPROCESS.ARTIFICIAL_DESTABILISATION_BACKEND),
                                          "amp{0}".format(config.VALID.DATA.PREPROCESS.ARTIFICIAL_DESTABILISATION_AMPLITUDE)
                                                ])
        ...
        config.TEST.DATA.EXP_DATA_NAME = "_".join([config.TEST.DATA.DATASET, "SizeW{0}".format(
            ...
            str(config.TEST.DATA.PREPROCESS.CHUNK_LENGTH)), "DataType{0}".format("_".join(config.TEST.DATA.PREPROCESS.DATA_TYPE)),
                                      ...
                                      "Dyamic_Det{0}".format(config.TEST.DATA.PREPROCESS.CROP_FACE.DETECTION.DO_DYNAMIC_DETECTION),
                                        ...
                                        "D{0}".format(config.TEST.DATA.PREPROCESS.ARTIFICIAL_DESTABILISATION_BACKEND),
                                        "amp{0}".format(config.TEST.DATA.PREPROCESS.ARTIFICIAL_DESTABILISATION_AMPLITUDE)
                                              ])
        ...
        config.UNSUPERVISED.DATA.EXP_DATA_NAME = "_".join([config.UNSUPERVISED.DATA.DATASET, "SizeW{0}".format(
            ...
            str(config.UNSUPERVISED.DATA.PREPROCESS.CHUNK_LENGTH)), "DataType{0}".format("_".join(config.UNSUPERVISED.DATA.PREPROCESS.DATA_TYPE)),
                                      ...
                                      "Dyamic_Det{0}".format(config.UNSUPERVISED.DATA.PREPROCESS.CROP_FACE.DETECTION.DO_DYNAMIC_DETECTION),
                                        ...
                                        "D{0}".format(config.UNSUPERVISED.DATA.PREPROCESS.ARTIFICIAL_DESTABILISATION_BACKEND),
                                        "amp{0}".format(config.UNSUPERVISED.DATA.PREPROCESS.ARTIFICIAL_DESTABILISATION_AMPLITUDE),
                                        "unsupervised"
                                              ])
