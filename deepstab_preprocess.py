...
import numpy as np
import scipy
from PyEVM.video_reader import VideoReader, OpenCVVideoWriter
...
for file in files:
    if file.endswith(".avi"):
        ...
        video_reader = VideoReader(curr_stable_file)
        stable_video = video_reader.read_n(999999)
        video_reader.release()

        video_reader = VideoReader(curr_unstable_file)
        unstable_video = video_reader.read_n(999999)
        video_reader.release()
